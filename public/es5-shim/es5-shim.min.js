...
(function (t, e) {
    ...
    var v;
    var g = Function.prototype.toString, y = function dt(t) {
        try {
            g.call(t);
            return true
        } catch (e) {
    ...
    }, d = "[object Function]", m = "[object GeneratorFunction]";
    v = function mt(t) {
    ...
    var b;
    var w = RegExp.prototype.exec, T = function bt(t) {
        try {
            w.call(t);
            return true
        } catch (e) {
    ...
    var O;
    var j = String.prototype.valueOf, S = function Tt(t) {
        try {
            j.call(t);
            return true
        } catch (e) {
    ...
    var G = !{toString: null}.propertyIsEnumerable("toString"), H = function () {
    }.propertyIsEnumerable("prototype"), L = !A("x", "0"), X = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], Y = X.length;
    I(Object, {
        keys: function Bt(t) {
            var e = v(t), r = E(t), n = t !== null && typeof t === "object", i = n && O(t);
            if (!n && !e && !r) {
    ...
    if (!Date.parse || rt || et || !tt) {
        Date = function (t) {
            ...
            I(e, {now: t.now, UTC: t.UTC}, true);
            e.prototype = t.prototype;
            I(e.prototype, {constructor: e}, true);
            var u = function c(e) {
                var n = r.exec(e);
                if (n) {
    ...
    var it = {
        base: 1e7, size: 6, data: [0, 0, 0, 0, 0, 0], multiply: function Yt(t, e) {
            var r = -1;
            var n = e;
            while (++r < it.size) {
                n += t * it.data[r];
