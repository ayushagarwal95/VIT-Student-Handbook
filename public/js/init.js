window.Modernizr = function (a, b, c) {
    ...
    function n(a) {
        ...
        return !A || a.printShived ? a : ("undefined" == typeof h[z] && h.add(z), i.attachEvent("onbeforeprint", function () {
            ...
            for (; h = n.pop();)if (!h.disabled && y.test(h.media)) {
                try {
    ...
    var o, p, q = "3.7.0", r = a.html5 || {}, s = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, t = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, u = "_html5shiv", v = 0, w = {};
    !function () {
        try {
    ...
    a.html5 = x, i(b);
    var y = /^$|\b(?:all|print)\b/, z = "html5shiv", A = !p && function () {
    ...
    Modernizr.addTest("bgsizecover", "cover" == b.backgroundSize)
}), function () {
    function a(a) {
        return window.getComputedStyle ? getComputedStyle(a, null).getPropertyValue("background") : a.currentStyle.background
    }

    Modernizr.testStyles(" #modernizr { background-repeat: round; } ", function (b) {
        Modernizr.addTest("bgrepeatround", "round" == a(b))
    }), Modernizr.testStyles(" #modernizr { background-repeat: space; } ", function (b) {
        Modernizr.addTest("bgrepeatspace", "space" == a(b))
    })
}(), Modernizr.addTest("bgpositionxy", function () {
    return Modernizr.testStyles("#modernizr {background-position: 3px 5px;}", function (a) {
        var b = window.getComputedStyle ? getComputedStyle(a, null) : a.currentStyle, c = "3px" == b.backgroundPositionX || "3px" == b["background-position-x"], d = "5px" == b.backgroundPositionY || "5px" == b["background-position-y"];
        return c && d
    })
...
}), Modernizr.testStyles(" #modernizr { display: run-in; } ", function (a) {
    var b = window.getComputedStyle ? getComputedStyle(a, null).getPropertyValue("display") : a.currentStyle.display;
    Modernizr.addTest("display-runin", "run-in" == b)
...
}), Modernizr.addTest("cssmask", Modernizr.testAllProps("maskRepeat")), Modernizr.addTest("lastchild", function () {
...
}), Modernizr.addTest("mediaqueries", Modernizr.mq("only all")), Modernizr.addTest("object-fit", !!Modernizr.prefixed("objectFit")), Modernizr.addTest("overflowscrolling", function () {
    return Modernizr.testAllProps("overflowScrolling")
}), Modernizr.addTest("csspositionsticky", function () {
    var a = "position:", b = "sticky", c = document.createElement("modernizr"), d = c.style;
    return d.cssText = a + Modernizr._prefixes.join(b + ";" + a).slice(0, -a.length), -1 !== d.position.indexOf(b)
...
}), Modernizr.addTest("shapes", Modernizr.testAllProps("shapeOutside", "content-box", !0)), Modernizr.addTest("cssresize", Modernizr.testAllProps("resize")), Modernizr.addTest("subpixelfont", function () {
    ...
    return Modernizr.testStyles(b, function (b) {
        var c = b.firstChild;
        c.innerHTML = "This is a text written in Arial", a = window.getComputedStyle ? "44px" !== window.getComputedStyle(c, null).getPropertyValue("width") : !1
    }, 1, ["subpixel"]), a
}), Modernizr.addTest("supports", "CSSSupportsRule"in window), Modernizr.addTest("userselect", function () {
    return Modernizr.testAllProps("user-select")
}), Modernizr.addTest("cssvhunit", function () {
    var a;
    return Modernizr.testStyles("#modernizr { height: 50vh; }", function (b) {
        var c = parseInt(window.innerHeight / 2, 10), d = parseInt((window.getComputedStyle ? getComputedStyle(b, null) : b.currentStyle).height, 10);
        a = d == c
    }), a
}), Modernizr.addTest("cssvmaxunit", function () {
    var a;
    return Modernizr.testStyles("#modernizr { width: 50vmax; }", function (b) {
        var c = window.innerWidth / 100, d = window.innerHeight / 100, e = parseInt((window.getComputedStyle ? getComputedStyle(b, null) : b.currentStyle).width, 10);
        a = parseInt(50 * Math.max(c, d), 10) == e
    }), a
}), Modernizr.addTest("cssvminunit", function () {
    var a;
    return Modernizr.testStyles("#modernizr { width: 50vmin; }", function (b) {
        var c = window.innerWidth / 100, d = window.innerHeight / 100, e = parseInt((window.getComputedStyle ? getComputedStyle(b, null) : b.currentStyle).width, 10);
        a = parseInt(50 * Math.min(c, d), 10) == e
    }), a
}), Modernizr.addTest("cssvwunit", function () {
    var a;
    return Modernizr.testStyles("#modernizr { width: 50vw; }", function (b) {
        var c = parseInt(window.innerWidth / 2, 10), d = parseInt((window.getComputedStyle ? getComputedStyle(b, null) : b.currentStyle).width, 10);
        a = d == c
    }), a
}), Modernizr.load([{
    test: Modernizr.cssvwunit && Modernizr.cssvhunit,
    nope: ["js/polyfills/vminpoly/tokenizer.js", "js/polyfills/vminpoly/parser.js", "js/polyfills/vminpoly/vminpoly.js"]
}, {
    test: Modernizr.audio && Modernizr.video,
    nope: "js/polyfills/html5media/html5media.min.js"
}, {
    test: Modernizr.mq("only all"),
    nope: "js/polyfills/respond-minmax/respond.min.js"
}, {
    test: Modernizr.csstransforms && Modernizr.csstransforms3d,
    nope: ["js/polyfills/transformie/sylvester.js", "js/polyfills/transformie/transformie.js"]
}, {
    test: Modernizr.localstorage && Modernizr.sessionstorage,
    nope: "js/polyfills/polyfill-storage/storage.js"
}]), function () {
